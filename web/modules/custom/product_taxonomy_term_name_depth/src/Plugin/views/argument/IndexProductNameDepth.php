...
namespace Drupal\product_taxonomy_term_name_depth\Plugin\views\argument;
 ...
 *
 * @ViewsArgument("taxonomy_index_product_name_depth")
 */
class IndexProductNameDepth extends ArgumentPluginBase {
